...
namespace Slidable.Identity.Areas.Identity.Pages.Account
{
    public class ExternalLoginModel : PageModel
    {
        ...
        private async Task CreateAuthenticationCookie(ApplicationUser user)
        {
            ...
            {
                new Claim(SlidableClaimTypes.Handle, user.Handle),
        ...
        private async Task CreateAuthenticationCookie(ClaimsPrincipal user)
        {
            ...
            {
                claims.Add(new Claim(SlidableClaimTypes.Handle, handle));
            }
